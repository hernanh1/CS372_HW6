...
_testhw6:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  12:	51                   	push   %ecx
  int temp1 = clone();
  13:	e8 2b 03 00 00       	call   343 <clone>
  18:	89 c3                	mov    %eax,%ebx
  int temp2 = join();
  1a:	e8 2c 03 00 00       	call   34b <join>
  printf(1, "Clone: %d    Join: %d\n\n", temp1, temp2);
  1f:	50                   	push   %eax
  20:	53                   	push   %ebx
  21:	68 78 07 00 00       	push   $0x778
  26:	6a 01                	push   $0x1
  28:	e8 e3 03 00 00       	call   410 <printf>

  exit();
  2d:	e8 71 02 00 00       	call   2a3 <exit>
  32:	66 90                	xchg   %ax,%ax
  34:	66 90                	xchg   %ax,%ax
  36:	66 90                	xchg   %ax,%ax
  38:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 594:	eb 1a                	jmp    5b0 <printf+0x1a0>
          s = "(null)";
 596:	bb 90 07 00 00       	mov    $0x790,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e5:	a1 44 0a 00 00       	mov    0xa44,%eax
{
 ...
 606:	73 10                	jae    618 <free+0x38>
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 637:	5e                   	pop    %esi
 638:	5f                   	pop    %edi
 639:	5d                   	pop    %ebp
 ...
 657:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 65a:	a3 44 0a 00 00       	mov    %eax,0xa44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 67d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 680:	8b 3d 44 0a 00 00    	mov    0xa44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6c9:	8b 3d 44 0a 00 00    	mov    0xa44,%edi
 ...
 6f2:	e8 e9 fe ff ff       	call   5e0 <free>
  return freep;
 6f7:	a1 44 0a 00 00       	mov    0xa44,%eax
 ...
 724:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 727:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 ...
 73e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 44 0a 00 00 48 	movl   $0xa48,0xa44
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf 48 0a 00 00       	mov    $0xa48,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 48 0a 00 00 48 	movl   $0xa48,0xa48
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 75b:	c7 05 4c 0a 00 00 00 	movl   $0x0,0xa4c
 762:	00 00 00 
    if(p->s.size >= nunits){
